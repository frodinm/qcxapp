              ...
              if(TouchableNativeFeedback.canUseNativeForeground()){
                  return( 
                    <View style={{alignItems:'center'}}>
                      <TouchableNativeFeedback onPress={()=>{}} useForeground={true} background={TouchableNativeFeedback.Ripple()} delayPressIn={0}>
                        <View style={{backgroundColor:'white',height:60,width:width,alignItems:'center',flexDirection:'row'}}>
                          <Text style={[iOSUIKit.subhead,{marginLeft:10}]}>{text}</Text>
                        </View>
                      </TouchableNativeFeedback>         
                  ...
                  return (
                    <View  style={{alignItems:'center'}}>
                      <TouchableHighlight onPress={()=>{}}>
                        <View style={{backgroundColor:'white',height:60,width:width,alignItems:'center',flexDirection:'row'}}>
                          <Text style={[iOSUIKit.caption,{marginLeft:10}]}>{text}</Text>
    ...
    render() {
        ...
        return(
            <View style={styles.container}>
                    <Text style={{color:'black',margin:15,marginTop:25}}>ACCOUNT</Text>
