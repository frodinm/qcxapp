...
export const POST_USER_QUADRIGA_BITCOIN_WITHDRAW = createAction('POST_USER_QUADRIGA_BITCOIN_WITHDRAW');
export const POST_USER_QUADRIGA_ETHER_WALLET = createAction('POST_USER_QUADRIGA_ETHER_WALLET');
export const POST_USER_QUADRIGA_ETHER_WITHDRAW = createAction('POST_USER_QUADRIGA_ETHER_WITHDRAW');
